...
class PPRExportOperation: Operation {
  ...
  init(_ aRecipe: PPRRecipeMO, completionHandler aHandler:
    @escaping (_ data: Data?, _ error: Error?) -> Void) {
  ...
  override func main() {
    ...
    let localMOC = NSManagedObjectContext(concurrencyType: t)
  ...
  func moToDictionary(_ mo: NSManagedObject) -> [String:Any] {
    var dict = [String:Any]()
...
class PPRImportOperation: Operation {
  ...
  func populateFromDictionary(_ incoming: [String: Any],
    ...
    let createChild: (_ childDict: [String:Any],
