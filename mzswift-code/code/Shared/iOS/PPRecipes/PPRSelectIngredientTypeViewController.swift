...
class PPRSelectIngredientTypeViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let request = NSFetchRequest<NSManagedObject>(entityName: "Ingredient")
...
//MARK: UITableViewDataSource
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let ingredientType = fResultsController?.object(at: indexPath)
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
          if let objectToDelete = fResultsController?.object(at: indexPath) {
...
//MARK: UITableViewDelegate
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
      if let ingredientType = fResultsController?.object(at: indexPath) {
