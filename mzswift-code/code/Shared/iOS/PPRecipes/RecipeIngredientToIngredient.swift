...
class RecipeIngredientToIngredient: NSEntityMigrationPolicy {
  ...
  override func createDestinationInstances(forSource src: NSManagedObject,
    ...
    guard let name = src.value(forKey: "name") as? String else {
    ...
    if dest == nil {
      ...
      guard let uofmName = src.value(forKey: "unitOfMeasure") as? String else {
  ...
  override func createRelationships(forDestination dest: NSManagedObject,
