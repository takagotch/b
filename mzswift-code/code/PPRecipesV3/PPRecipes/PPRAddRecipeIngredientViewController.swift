...
class PPRAddRecipeIngredientViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        guard let ingredientType = recipeIngredientMO.value(forKey: "ingredient") else {
            return
        }
        ...
        cell.textLabel?.text = (ingredientType as AnyObject).value(forKeyPath: "unitOfMeasure.name") as? String
    }
