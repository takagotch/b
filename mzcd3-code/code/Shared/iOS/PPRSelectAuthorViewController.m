...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  PPRTextEditViewController *viewController = [[PPRTextEditViewController alloc] initWithNibName:@"PPRAddAuthorView" bundle:nil];
  [viewController setTitle:@"Add Author"];
