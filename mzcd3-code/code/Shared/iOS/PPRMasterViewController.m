...
- (void)prepareForAddRecipeSegue:(UIStoryboardSegue*)segue sender:(id)sender
{
  ...
  PPRRecipeMO *newRecipeMO = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:context];
  [[segue destinationViewController] setRecipeMO:newRecipeMO];
}
